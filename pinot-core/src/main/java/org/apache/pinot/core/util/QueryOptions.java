...
public class QueryOptions {
  ...
  @Nullable
  public Boolean isEnableSegmentTrim() { return _enableSegmentTrim; }

  @Nullable
  public Integer getSegmentTrimSize() {return _segmentTrimSize; }
  ...
  public static Boolean getEnableSegmentTrim(Map<String, String> queryOptions) {
    String enableSegmentTrim = queryOptions.get(Request.QueryOptionKey.SEGMENT_TRIM_ENABLE);
  ...
  public static Integer getSegmentTrimSize(Map<String, String> queryOptions) {
    String SegmentTrimSize = queryOptions.get(Request.QueryOptionKey.SEGMENT_TRIM_SIZE);
